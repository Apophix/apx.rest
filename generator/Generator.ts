...
class ApiPath implements TApiPathDto {
	...
	private renderRequestAndResponse(requestDtoName: string, responseDtoName: string, finalResponse: string, clientFunctionName: string): string {
		return `public async ${this.operationId}(request: ${requestDtoName}): Promise<${finalResponse}> {
	...
	private renderRequestOnly(requestDtoName: string, clientFunctionName: string): string {
		return `public async ${this.operationId}(request: ${requestDtoName}): Promise<boolean> {
	...
	private renderResponseOnly(responseDtoName: string, clientFunctionName: string): string {
		return `public async ${this.operationId}(): Promise<${responseDtoName}> {
	...
	private renderNoRequestNoResponse(clientFunctionName: string): string {
		return `public async ${this.operationId}(): Promise<boolean> {
